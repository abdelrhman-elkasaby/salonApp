class ModelProviderDetails {
  String key;
  String value;
  DataBean data;

  ModelProviderDetails({this.key, this.value, this.data});

  ModelProviderDetails.fromJson(Map<String, dynamic> json) {    
    this.key = json['key'];
...
class DataBean {
  ...
  DataBean({this.shareLink, this.info, this.services});

  DataBean.fromJson(Map<String, dynamic> json) {    
    this.shareLink = json['share_link'];
...
class InfoBean {
  ...
  InfoBean({this.image, this.name, this.address, this.description, this.lat, this.lng, this.phone, this.startTime, this.endTime, this.rate});
